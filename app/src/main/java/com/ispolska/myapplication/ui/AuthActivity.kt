...
import com.ispolska.myapplication.common.Constants.ISLOGINED
import com.ispolska.myapplication.common.Constants.PASSWORD_LENGTH
import com.ispolska.myapplication.common.Constants.PASSWORD_LOWERCASE_LETTERS
import com.ispolska.myapplication.common.Constants.PASSWORD_NUMBERS
import com.ispolska.myapplication.common.Constants.PASSWORD_UPPERCASE_LETTERS
...
//        if (!(pass.contains(PASSWORD_UPPERCASE_LETTERS) && pass.contains(PASSWORD_LOWERCASE_LETTERS)
//            && pass.contains(PASSWORD_NUMBERS) && pass.length >= PASSWORD_LENGTH)) {
//            return false
//        }
        if (!pass.matches(
